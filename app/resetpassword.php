<script src="js/passwordresetkey.js" defer></script>
		<section class="section">
			<h3 class="title is-3">Password reset</h3>
			<form id="resetform">
			<div class="field">
					<p>Give your username and email-address and we'll send you a link to reset your password.</p>
			</div>
			<div class="field">
