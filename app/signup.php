				...
				<div class="control has-icons-left has-icons-right">
					<?php
						if (isset($_GET['error']) && ($_GET['error'] == "emailtaken" || $_GET['error'] == "invalidemail")) {
							echo '<input class="input is-danger" type="email" name="email" placeholder="Email" maxlength="320" required>';
						}
						else {
							echo '<input class="input" type="email" name="email" placeholder="Email" maxlength="320" required>';
						}
					?>
				...
				<div class="control has-icons-left has-icons-right">
					<?php
						if (isset($_GET['error']) && $_GET['error'] == "usernametaken") {
							echo '<input class="input is-danger" type="text" name="username" placeholder="Username" minlength="3" maxlength="32" required>';
						}
						else {
							echo '<input class="input" type="text" name="username" placeholder="Username" minlength="3" maxlength="32" required>';
						}
					?>
					<span class="icon is-small is-left">
						<svg style="width:24px;height:24px" viewBox="0 0 24 24">
				...
				<div class="control has-icons-left has-icons-right">
					<?php
						if (isset($_GET['error']) && $_GET['error'] == "invalidpasswd") {
							echo '<input class="input is-danger" type="password" name="passwd" placeholder="Password" minlength="8" maxlength="255" required>';
						}
						else {
							echo '<input class="input" type="password" name="passwd" placeholder="Password" minlength="8" maxlength="255" required>';
						}
					?>
					<span class="icon is-small is-left">
						<svg style="width:24px;height:24px" viewBox="0 0 24 24">
				...
				<div class="control has-icons-left has-icons-right">
					<?php
						if (isset($_GET['error']) && $_GET['error'] == "passwdnotmatch") {
							echo '<input class="input is-danger" type="password" name="passwd2" placeholder="Password" minlength="8" maxlength="255" required>';
						}
						else {
							echo '<input class="input" type="password" name="passwd2" placeholder="Password" minlength="8" maxlength="255" required>';
						}
					?>
					<span class="icon is-small is-left">
						<svg style="width:24px;height:24px" viewBox="0 0 24 24">
			...
			<div class="field">
  				<div class="control">
    				<label class="checkbox">
      					<input type="checkbox" name="tc" value="TRUE" required>
					</label>
					I agree to the <a class="js-modal-trigger" data-target="tc">terms and conditions</a>
				</div>
			</div>
		...
		<div class="modal" id="tc">
			...
			<div class="modal-card">
				...
				<footer class="modal-card-foot">
					<button class="button is-success">Agree</button>
